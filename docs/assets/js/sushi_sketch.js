...
var Nigiri = function (_PIXI$Container2) {
	...
	function Nigiri(netaName) {
		...
		var _this2 = _possibleConstructorReturn(this, (Nigiri.__proto__ || Object.getPrototypeOf(Nigiri)).call(this));
...
var SushiSketch = function () {
	function SushiSketch(canvasElement) {
		_classCallCheck(this, SushiSketch);
